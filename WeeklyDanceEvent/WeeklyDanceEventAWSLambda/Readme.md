...
```
    cd "WeeklyDanceEventAWSLambda"
    dotnet restore
```

Execute unit tests
```
    cd "WeeklyDanceEventAWSLambda/test/WeeklyDanceEventAWSLambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "WeeklyDanceEventAWSLambda/src/WeeklyDanceEventAWSLambda"
